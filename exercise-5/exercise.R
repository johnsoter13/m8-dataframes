...
mean.grant <- sum(spending) / length(org)
...
largest.received <- grants[spending == largest.grant,]

# Which organization received the smallest grant?
smallest.received <- grants[spending == smallest.grant,]

# How many grants were awarded in 2010?
grants.in.2010 <- length(grants[grants$start_year == 2010,"start_year"])