...
most.yards <- husky.scores[which(combined.yards == max(combined.yards)),]
...
husky.games.2016 <- read.csv("C:\\Users\\MCGWoody\\Documents\\Info201\\m8-dataframes\\exercise-7\\data\\huskies_2015.csv")
